jQuery(document).ready(function($){
    ...
    at.on('alphaTab.loaded', function(e, score) {
        ...
        for( var i = 0; i < score.Tracks.length; i++) {
            ...
            var solo = $('<button type="button" class="gem-button micro grey">Solo</button>');
            ...
            var mute = $('<button type="button" class="gem-button micro grey">Mute</button>');
    ...
    // Open track list
    $('#currentTrack, #close-tracks').click(function() {
        console.log('Open track list;');
        $('#trackList').slideToggle();
    });

    // Bump chat button up
    var containHeight = $('.navbar.navbar-default').height();
