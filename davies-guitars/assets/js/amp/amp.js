...
var demoSampleURLs = [
  "/wp-content/plugins/davies-guitars/assets/other/audio/Guitar_DI_Track.mp3", 				// 0
  "/wp-content/plugins/davies-guitars/assets/other/audio/LasseMagoDI.mp3", 					// 1
  "/wp-content/plugins/davies-guitars/assets/other/audio/RawPRRI.mp3", 						// 2
  "/wp-content/plugins/davies-guitars/assets/other/audio/Di-Guitar.mp3", 						// 3
  "/wp-content/plugins/davies-guitars/assets/other/audio/NarcosynthesisDI.mp3", 				// 4
  "/wp-content/plugins/davies-guitars/assets/other/audio/BlackSabbathNIB_rythmDI.mp3", 		// 5
  "/wp-content/plugins/davies-guitars/assets/other/audio/BlackSabbathNIBLead_DI.mp3", 		// 6
  "/wp-content/plugins/davies-guitars/assets/other/audio/BasketCase Greenday riff DI.mp3", 	// 7
  "/wp-content/plugins/davies-guitars/assets/other/audio/InBloomNirvanaRiff1DI.mp3", 			// 8
  "/wp-content/plugins/davies-guitars/assets/other/audio/Muse1Solo.mp3", 						// 9
  "/wp-content/plugins/davies-guitars/assets/other/audio/Muse2Rytbhahm.mp3", 					// 10
  "/wp-content/plugins/davies-guitars/assets/other/audio/Guitar-DI-Sample.wav", 				// 11
  "/wp-content/plugins/davies-guitars/assets/other/audio/Master-Of-Puppets.mp3", 				// 12
  "/wp-content/plugins/davies-guitars/assets/other/audio/Funky-Guitar.mp3", 					// 13
  "/wp-content/plugins/davies-guitars/assets/other/audio/Les-Paul-Chords.mp3" 				// 14
];
...
function toggleGuitarInput(event) {
    ...
    if(!guitarPluggedIn) {
        guitarInput.connect(amp.input);
        button.innerHTML = "Deactivate Guitar Input";
        button.classList.remove("guitar-inactive");
        button.classList.add("guitar-active");
    } else {
        guitarInput.disconnect();
        button.innerHTML = "Activate Guitar Input";
        // button.classList.add("pulse");
        button.classList.remove("guitar-active");
        button.classList.add("guitar-inactive");
    }
...
function Amp(context) {
    ...
    */
    ...
    changeOutputGainValue(3); // chris changed from 7 to 3
    ...
    bassFilter.frequency.value = 60; //Chris changed from 100 to 60
...
*/	
	...
	// Chris attempt to make a comproessor. Set up and initialize
    ...
    function buildGraph() {
        ...
        // Connected comp
        //cabinetSim.output.connect(compressor);
	...
	function compToggleOn(compressor) {
	    console.log('ComptoggleOn functoin executed');
	    compressor.threshold.value = 0;
	}
	function compToggleOff(compressor) {
	    console.log('ComptoggleOff function executed');
    ...
    function changeCompThresh(sliderVal) {
    	// Change this to comp threshold
        var compVal =  parseFloat(sliderVal);

        compressor.threshold.setValueAtTime(compVal, context.currentTime)

        console.log("Compressor Threshold Value = " + compVal);
        console.log('Compression Reduction: ' + compressor.reduction);

        var compReductionText = document.querySelector("#gain-reduction");
        compReductionText.innerHTML = 'Gain Reduction: ' + Math.round(compressor.reduction) + ' DB';
    }
  ...
  function changeBassFilterValue(sliderVal) {
    ...
    function initPresets() {
        ...
        var preset10 = {"name":"Metal Scooped","boost":false,"LS1Freq":720,"LS1Gain":-6,"LS2Freq":320,"LS2Gain":-5,"gain1":1,"distoName1":"vertical","K1":"7.1","HP1Freq":6,"HP1Q":0.707099974155426,"LS3Freq":720,"LS3Gain":-6,"gain2":1,"distoName2":"ClassA","K2":"7.1","OG":"7.0","BF":"8.9","MF":"5.8","TF":"6.6","PF":"6.0","EQ":[5,11,-6,-9,7,2],"MV":"7.8","RN":"Fender Hot Rod","RG":"0.0","CN":"Mesa Boogie 4x12","CG":"9.8"}
        presets.push(preset10);

        var preset9 = {"name":"Modern Metal","boost":false,"LS1Freq":720,"LS1Gain":-6,"LS2Freq":320,"LS2Gain":-5,"gain1":1,"distoName1":"vertical","K1":"5.5","HP1Freq":6,"HP1Q":0.707099974155426,"LS3Freq":720,"LS3Gain":-6,"gain2":1,"distoName2":"ClassA","K2":"5.5","OG":"5.1","BF":"9.1","MF":"9.6","TF":"5.2","PF":"6.8","EQ":[5,11,-6,-9,7,2],"MV":"7.8","RN":"Fender Hot Rod","RG":"0.0","CN":"EVH 5150","CG":"10.0"}
        ...
        var preset6 = {"name":"Rock Lead","boost":false,"LS1Freq":720,"LS1Gain":-6,"LS2Freq":320,"LS2Gain":-7.5,"gain1":1,"distoName1":"standard","K1":"6.7","HP1Freq":6,"HP1Q":0.707099974155426,"LS3Freq":720,"LS3Gain":-6,"gain2":1,"distoName2":"standard","K2":"6.7","OG":"7.0","BF":"4.3","MF":"2.6","TF":"6.1","PF":"4.2","EQ":[5,12,-5,-10,2,10],"MV":"9.8","RN":"Fender Hot Rod","RG":"0.0","CN":"Marshall 1960, axis","CG":"8.4"};
    ...
    return { 
        ...
        changeCompThresh: changeCompThresh,
...
var reverbImpulses = [
        {
            name: "Fender Hot Rod",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/reverb/cardiod-rear-levelled.wav"
        },
        {
            name: "PCM 90 clean plate",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/reverb/pcm90cleanplate.wav"
        },
        {
            name: "Scala de Milan",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/reverb/ScalaMilanOperaHall.wav"
        }
    ];
var cabinetImpulses = [
        {
            name: "Mesa Boogie 4x12",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/cabinet/Mesa-OS-Rectifier-3.wav"
        },
        {
            name: "EVH 5150 4x12",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/cabinet/EVH-5150-3.wav"
        },
		{
            name: "Marshall 1960, axis",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/cabinet/Marshall1960.wav"
        },    
        {
            name: "Vintage Marshall 1",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/cabinet/Block%20Inside.wav"
        },
        {
            name: "Vox Custom Bright 4x12 M930 Axis 1",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/cabinet/voxCustomBrightM930OnAxis1.wav"
        },
        {
            name: "Fender Champ, axis",
            url: "/wp-content/plugins/davies-guitars/assets/other/impulses/cabinet/FenderChampAxisStereo.wav"
        }
