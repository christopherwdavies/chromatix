...
var demoSampleURLs = [
  "/wp-content/plugins/guitar-amp/assets/audio/Guitar_DI_Track.mp3", 				// 0
  "/wp-content/plugins/guitar-amp/assets/audio/LasseMagoDI.mp3", 					// 1
  "/wp-content/plugins/guitar-amp/assets/audio/RawPRRI.mp3", 						// 2
  "/wp-content/plugins/guitar-amp/assets/audio/Di-Guitar.mp3", 						// 3
  "/wp-content/plugins/guitar-amp/assets/audio/NarcosynthesisDI.mp3", 				// 4
  "/wp-content/plugins/guitar-amp/assets/audio/BlackSabbathNIB_rythmDI.mp3", 		// 5
  "/wp-content/plugins/guitar-amp/assets/audio/BlackSabbathNIBLead_DI.mp3", 		// 6
  "/wp-content/plugins/guitar-amp/assets/audio/BasketCase Greenday riff DI.mp3", 	// 7
  "/wp-content/plugins/guitar-amp/assets/audio/InBloomNirvanaRiff1DI.mp3", 			// 8
  "/wp-content/plugins/guitar-amp/assets/audio/Muse1Solo.mp3", 						// 9
  "/wp-content/plugins/guitar-amp/assets/audio/Muse2Rythm.mp3", 					// 10
  "/wp-content/plugins/guitar-amp/assets/audio/Guitar-DI-Sample.wav", 				// 11
  "/wp-content/plugins/guitar-amp/assets/audio/Master-Of-Puppets.mp3", 				// 12
  "/wp-content/plugins/guitar-amp/assets/audio/Funky-Guitar.mp3", 					// 13
  "/wp-content/plugins/guitar-amp/assets/audio/Les-Paul-Chords.mp3" 				// 14
...
var reverbImpulses = [
        {
            name: "Fender Hot Rod",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/reverb/cardiod-rear-levelled.wav"
        },
        {
            name: "PCM 90 clean plate",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/reverb/pcm90cleanplate.wav"
        },
        {
            name: "Scala de Milan",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/reverb/ScalaMilanOperaHall.wav"
        }
    ];
var cabinetImpulses = [
        {
            name: "Mesa Boogie 4x12",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/cabinet/Mesa-OS-Rectifier-3.wav"
        },
        {
            name: "EVH 5150 4x12",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/cabinet/EVH-5150-3.wav"
        },
		{
            name: "Marshall 1960, axis",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/cabinet/Marshall1960.wav"
        },    
        {
            name: "Vintage Marshall 1",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/cabinet/Block%20Inside.wav"
        },
        {
            name: "Vox Custom Bright 4x12 M930 Axis 1",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/cabinet/voxCustomBrightM930OnAxis1.wav"
        },
        {
            name: "Fender Champ, axis",
            url: "/wp-content/plugins/guitar-amp/assets/impulses/cabinet/FenderChampAxisStereo.wav"
        }
