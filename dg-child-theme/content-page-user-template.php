 ...
 */
	...
	if (is_user_logged_in()) {
		get_template_part( 'content', 'account-header-template' );
		$user_class = 'col-md-12 col-xs-12 main-section';
	} else {
...
<div class="block-content<?php echo esc_attr($thegem_no_margins_block); ?> account-content">
...
<!-- 			<?php if (is_user_logged_in()) :?>
				<div class="col-md-3 col-xs-12 sidebar" id="user-sidebar">
					<?php if ( is_active_sidebar( 'user-account-sidebar' ) ) {
					    dynamic_sidebar('user-account-sidebar');
					} ?>
				</div>
			<?php endif ?> -->

			<div class="<?php echo esc_attr($thegem_center_classes); ?> <?php echo $user_class ?>">
