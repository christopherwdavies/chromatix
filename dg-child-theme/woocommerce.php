 ...
 */
	...
	if( ! is_product() ) {					//line added by chris
		$thegem_sidebar_position = 'left'; 	//line added by chris
	}										//line added by chris
	...
	// if(is_active_sidebar('shop-sidebar') && $thegem_sidebar_position) { // original line
	if( ! is_product() && $thegem_sidebar_position ) { // line modified by chris
...
<?php do_action('cd_wp_under_header'); ?>
