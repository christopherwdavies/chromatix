...
<tr class="<?php echo esc_attr( $tr_class ); ?>">
    ...
    <td data-title="<?php esc_attr_e( 'Image', 'dokan-lite' ); ?>">
        <?php if ( current_user_can( 'dokan_edit_product' ) ): ?>
            <a href="<?php echo esc_url( cd_dokan_edit_product_url( $post->ID ) ); ?>"><?php echo wp_kses( $product->get_image(), $img_kses ); ?></a>
        <?php else: ?>
    ...
    <td data-title="<?php esc_attr_e( 'Name', 'dokan-lite' ); ?>">
        <?php if ( current_user_can( 'dokan_edit_product' ) ): ?>
            <p><a href="<?php echo esc_url( cd_dokan_edit_product_url( $post->ID ) ); ?>"><?php echo esc_html( $product->get_title() ); ?></a></p>
        <?php else: ?>
