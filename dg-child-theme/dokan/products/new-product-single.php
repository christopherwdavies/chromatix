...
$cd_product_cat = -1;
$cd_term = array();
$cd_term = wp_get_post_terms( $post_id, 'product_cat', array( 'fields' => 'ids') );

if ( $cd_term ) {
    $cd_product_category = reset( $cd_term );
    $category = get_term( $cd_product_category, 'product_cat' );
    $slug = $category->slug;
...
<?php do_action( 'dokan_dashboard_wrap_start' ); ?>
    ...
    <div class="dokan-dashboard-wrap">
        ...
        <div class="dokan-dashboard-content dokan-product-edit <?php echo $cat_class; ?>">
            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                <h1 class="entry-title">
                    ...
                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right product-edit">
            ...
            <div class="product-edit-new-container product-edit-container container">
                        ...
                        <form class="dokan-product-edit-form" role="form" method="post">
                            ...
                            <div class="dokan-form-top-area">
                                <div class="row add-new-product">
                                    <div class="dokan-form-group product-field product-title col-md-12">
                                        <input type="hidden" name="dokan_product_id" id="dokan-edit-product-id" value="<?php echo esc_attr( $post_id ); ?>"/>

                                        <label style="display:none;" for="post_title" class="form-label"><?php esc_html_e( 'Title', 'dokan-lite' ); ?></label>
                                ...
                                <div class="row add-new-product">
                                    <!-- Featured Image -->
                                    <div class="col-md-6 col-sm-12 cd-featured-image">
                                        ...
                                        <?php endif; ?>
                                    </div><!-- .content-half-part - image -->

                                <div class="col-md-6 col-sm-12 cd-dokan-product-meta">
                                    ...
                                    <?php if ( is_array( $product_types ) ): ?>
                                        <div class="dokan-form-group product-field prodct-type">
                                    ...
                                    <div class="show_if_simple dokan-clearfix">
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container product-field">
                                    ...
                                    <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        <div class="dokan-form-group product-field product-category">
                                    ...
                                    <div class="dokan-form-group product-field product-tags">
                            ...
                            <div class="dokan-product-short-description product-field">
                            ...
                            <div class="dokan-product-description product-field row add-new-product">
                                <div class="col-md-12">
                                    <label for="post_content" class="form-label"><?php esc_html_e( 'Description', 'dokan-lite' ); ?></label>
                                    <?php wp_editor( $post_content , 'post_content', apply_filters( 'dokan_product_description', array( 'editor_height' => 250, 'quicktags' => false, 'media_buttons' => false, 'teeny' => true, 'editor_class' => 'post_content' ) ) ); ?>
                                </div>
                            </div>
