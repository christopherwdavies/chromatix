    ...
    <div class="dokan-dashboard-wrap">
        ...
        <div class="dokan-dashboard-content">
            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                <h1 class="entry-title title-h3">
                    <?php esc_html_e( 'Add New Product', 'dokan-lite' ); ?>
                </h1>
            </header><!-- .entry-header -->


            <div class="dokan-new-product-area container">
                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                        ...
                        <form class="dokan-form-container" method="post">
                            ...
                            <div class="product-edit-container dokan-clearfix">
                                ...
                                <!-- Post title -->
                                <div class="dokan-form-group row add-new-product">
                                	<div class="col-md-12">
                                    	<input class="dokan-form-control" name="post_title" id="post-title" type="text" placeholder="<?php esc_attr_e( 'Product Title', 'dokan-lite' ); ?>" value="<?php echo esc_attr( dokan_posted_input( 'post_title' ) ); ?>">
                                        <span class="title-h5 add-new-product-subtitle">Currently Creating A Guitar Tone</span>
                                	</div>
                                </div>

                                <!-- Category Dropdown -->
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group row product-field category-dropdown" style="display:none;">
                                        <div class="col-md-12">
                                            <label for="product_cat" class="dokan-form-label"><?php esc_html_e( 'Category', 'dokan-lite' ); ?></label>
                                            <?php
                                            ...
                                            $category_args =  array(
                                                ...
                                                'exclude'          => '0,1,-1', // 0 = exclude uncategorized
                                ...
                                <div class="row add-new-product">
                                    ...
                                    <!-- Image -->
                                    <div class="cd-featured-image col-md-6 col-sm-12">
                                    ...
                                    <!-- Right top half -->
                                    <div class="cd-product-meta col-md-6 col-sm-12">
                                        <div class="dokan-form-group product-field full-price-container">
                                        ...
                                        <!-- Short description - removed by chris  -->
                                        <div class="dokan-form-group short-description-input product-field">
                                        ...
                                        <div class="dokan-form-group add-product-tags product-field">
                                            <?php
                                        ...
                                        <div class="sku-input product-field">
                                			<label for="_sku" class="dokan-form-label">Product SKU</label>
	                                    	<input class="dokan-form-control" name="_sku" id="_sku" type="text" placeholder="<?php esc_attr_e( 'Please Enter A SKU', 'dokan-lite' ); ?>" value="<?php echo esc_attr( dokan_posted_input( '_sku' ) ); ?>">
	                                	</div>
                                    </div>
                                </div><!-- End row -->

                                <!-- Description -->
                                <div class="dokan-form-group row add-new-product product-field">
                                    <div class="col-md-12">
                                        ...
                                        <?php wp_editor( htmlspecialchars_decode( $post_content, ENT_QUOTES ), 'post_content', array('editor_height' => 250, 'quicktags' => false, 'media_buttons' => false, 'teeny' => true, 'editor_class' => 'post_content') ); ?>
                                    </div>
                                </div>
                            ...
                            <!-- Start downloadable file area -->
                            <div class="dokan-side-body dokan-download-wrapper product-edit-container product-field add-new-product row col-md-12">
                                <label>Guitar Tone File(s)</label>
                                <p>Upload your guitar tone files here. This can either be in .zip format or directly uploaded as the preset/patch/profile.</p>
                                <table class="dokan-table">
                                    <tfoot>
                                        <tr>
                                            <th colspan="3" class="file-upload-row">
